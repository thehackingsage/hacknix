...
**********************************\033[0m
			''')
				...
				opcion0 = raw_input("\033[1;36mhacknix > \033[1;m")
...
''')
					...
					repo = raw_input("\033[1;32mDo You Want To Install Hacking Tool Menu ? [y/n]> \033[1;m")
					if repo == "y":
...
0) Install All Tools
			 ...
			 ''')
						...
						opcion1 = raw_input("\033[1;36mhacknix > \033[1;m")
						if opcion1 == "back":
							inicio1()
						elif opcion1 == "gohome":
							inicio1()
...
0) Install all Information Gathering tools
						...
						''')
							...
							opcion2 = raw_input("\033[1;36mhacknix > \033[1;m")
							if opcion2 == "1":
